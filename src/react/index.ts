 ...
 *
 * The transport is injectable — `createEventSource` and `fetch` — for the same
 * reason `createAgentHandler` takes a `createQuery`: the whole surface can be
 * driven with no network and no credential.
 */
